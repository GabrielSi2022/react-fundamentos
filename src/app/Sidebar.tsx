...
export default function Sidebar() {
  return (
    <div className=" bg-gray-900 rounded-lg ">
      ...
      <div className=" w-full">
        <div className=" flex flex-col items-center">
          ...
          <div className="mt-4 mb-6 flex flex-col">
            <strong className="text-base leading-6 text-gray-100 text-center ">
              Lara Lombardi
            </strong>
      ...
      <div
        className="border-t-[1px] border-gray-600
      ...
      >
        <button
          className="text-base text-green-500
                          ...
                          hover:bg-green-500 hover:text-white ease-in-out duration-150"
        >
          {" "}
          <PencilLine size={20} /> <a href="#">Editar seu Perfil</a>
        </button>
      </div>
    </div>
  );
